...
public class PatternElementParserTest {
    ...
    @Test
    public void parseElements_ListMatchAnyType_ReturnsCorrectStringElement() throws SpongeMatcherParseException {
    ...
    @Test
    public void parseElements_ListMatchAllType_ReturnsCorrectStringElement() throws SpongeMatcherParseException {
    ...
    @Test
    public void parseElements_NotType_ReturnsCorrectStringElement() throws SpongeMatcherParseException {
        String input = "!'test'";
    ...
    @Test
    public void parseElements_NotTypeWithSpaces_ReturnsCorrectStringElement() throws SpongeMatcherParseException {
        String input = "    ! 'test' ";
    ...
    @Test
    public void parseElements_ParanthesesType_ReturnsCorrectStringElement() throws SpongeMatcherParseException {
        String input = "('test')";
