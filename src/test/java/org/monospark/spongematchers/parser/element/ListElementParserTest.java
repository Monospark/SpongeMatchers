...
public class ListElementParserTest {
    ...
    @Test
    public void parseElements_ListElement_ReturnsCorrectStringElement() throws SpongeMatcherParseException {
    ...
    @Test
    public void parseElements_ListElementWithSpaces_ReturnsCorrectStringElement() throws SpongeMatcherParseException {
        String input = " [ 'test1'   , 'test2'   ,  'test3' ] ";
